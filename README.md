...
<a href="https://skillicons.dev"   >
  <img src="https://skv/icons?i=git,vscode,javascript,typescript,css,html,react,next,taillicons.deilwind,sass,nodejs,express,nest,vue,docker,figma,github,jest,materialui,linux,postman,styledcomponents,vercel,vite,bootstrap,mongodb,postgres,discord,linkedin,instagram" />
</a>
  <br />
